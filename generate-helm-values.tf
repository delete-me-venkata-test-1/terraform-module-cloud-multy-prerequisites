...
module "glueops_platform_helm_values" {
  ...
  source                                     = "git::https://github.com/GlueOps/platform-helm-chart-platform.git?ref=feat/venkata"
  ...
  demo_balaji_aws_username                   = "username-balaji"
  demo_balaji_aws_password                   = "password-balaji"
