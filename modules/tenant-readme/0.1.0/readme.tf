...
locals {
  codespace_version         = "v0.46.0"
  argocd_crd_version        = var.argocd_app_version
  argocd_helm_chart_version = "7.4.0"
  glueops_platform_version  = "v0.46.1" # this also needs to be updated in the module.glueops_platform_helm_values // generate-helm-values.tf
  tools_version             = "v0.10.1"
}
